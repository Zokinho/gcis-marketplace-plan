    ...
    <div className={`rounded-lg border card-blue border-l-4 shadow-md p-5 ${
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          <div className="hidden h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg sm:flex">
            {spotSale.product.imageUrls?.[0] ? (
              <ProductImage src={spotSale.product.imageUrls[0]} alt="" className="h-full w-full object-cover" />
            ) : (
              <ProductPlaceholder productId={spotSale.product.id} className="h-full w-full" iconSize="h-6 w-6" />
            )}
          </div>
